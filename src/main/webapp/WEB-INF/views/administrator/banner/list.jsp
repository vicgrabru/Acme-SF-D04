...
<acme:list>
	...
	<acme:list-column code="administrator.banner.list.label.period-start" path="periodStart" width="20%"/>
	<acme:list-column code="administrator.banner.list.label.period-end" path="periodEnd" width="20%"/>
</acme:list>
