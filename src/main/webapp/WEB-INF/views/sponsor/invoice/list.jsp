...
<acme:list>
	...
	<acme:list-column code="sponsor.invoice.list.label.registrationTime" path="registrationTime" width="50%"/>
	...
	<acme:button code="sponsor.invoice.list.button.create" action="/sponsor/invoice/create?masterId=${masterId}"/>
