...
<acme:form>
	<acme:input-textbox code="sponsor.invoice.form.label.code" path="code" readonly="${readOnlyCode}"/>
	...
	<jstl:if test="${acme:anyOf(_command, 'show|update|publish')}">
		<acme:input-money readonly="true" code="sponsor.invoice.form.label.exchanged-totalAmount" path="exchangedTotalAmount"/>
	</jstl:if>
	...
	<jstl:choose>
		<jstl:when test="${acme:anyOf(_command, 'show|update|delete|publish') && draftMode == true}">
			<acme:submit code="sponsor.invoice.form.button.update" action="/sponsor/invoice/update?id=${id}"/>
			<acme:submit code="sponsor.invoice.form.button.delete" action="/sponsor/invoice/delete?id=${id}"/>
			<acme:submit code="sponsor.invoice.form.button.publish" action="/sponsor/invoice/publish?id=${id}"/>
		</jstl:when>
